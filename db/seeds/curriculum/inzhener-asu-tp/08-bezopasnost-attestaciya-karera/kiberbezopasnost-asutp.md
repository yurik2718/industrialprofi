...
- объяснить, чем защита АСУ ТП отличается от обычной IT-безопасности;
- назвать ключевые требования закона (КИИ, ФСТЭК);
- понимать принципы защиты: зонирование и эшелонированную оборону.
