...
- проследить путь энергии: реактор → парогенератор → турбина → конденсатор → насосы → деаэратор → обратно;
- объяснить, зачем первый контур (радиоактивный) отделён от второго (чистого) и где проходит граница;
- показать на схеме, где меряют температуру, давление, расход и уровень — то есть где стоят твои приборы КИП.
